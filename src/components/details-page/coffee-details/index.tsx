              ...
              <>
                ...
                <div className="coffee-details-container">
                  ...
                  <div className="coffee-details-content">
                    <h1 className="coffee-details-title">
                      {coffee.name} coffee
                    </h1>
                    ...
                    <div className="coffee-details-description">
                      ...
                      <p>
                        Now, a couple of dad jokes: What did one plate whisper
                        to the other plate? Dinner is on me. Why did the
                        scarecrow win an award? He was outstanding in his field.
                        What are the strongest days of the week? Saturday and
                        Sunday. All the others are weekdays.
                      </p>
                    </div>
